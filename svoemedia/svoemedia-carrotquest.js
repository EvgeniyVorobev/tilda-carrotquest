...
var scriptSrc = 'https://hook.io/evgeniyvorobevv/svoemedia-carrotquest'; // Hook script src.
/* ..end [Preference] */
...
// ____----___---___---____-----___----___----- ____-----___-----___-----___-----___----//
            ...
            /* Send Data to CQ */
            function sendToCarrot(){
                console.log('Это $form', $form);
                console.log('Это $($form).closest("[data-payment-system]")[0]', $($form).closest("[data-payment-system]")[0]);
                if ( name != undefined || name != '') { // Update CQ user's name.
                    carrotquest.identify({
                        '$name': name
                    });
