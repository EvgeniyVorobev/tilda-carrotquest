...
var token = 'app.14283.2acf6f71e5667fc5c45cbc7edf127f69de3e23fb8f6524cf'; // токен из личного кабинета
...
var options = {
  ...
  form: {
  auth_token: token,
  body: 'Была заполнена форма '+params.formname+', пользователем '+params.name+'<br> Ссылка на страницу с формой: '+encodeURI(params.url)+' ;<br><br>Вся полученная информация: <br>'+params.allInfo 
  }
}  
